"""RAG Agent - extends simp-agent with RAG capabilities, filtering, query rewrite, and anti-hallucination."""
import os
import sys
...
class Agent:
    """
    LLM agent with optional RAG, filtering, query rewrite and anti-hallucination.
    
    Supports modes:
    - Without RAG: direct LLM query
    - With RAG: retrieval + optional filter + optional rewrite + anti-hallucination
    """
    ...
    def ask(self, question: str) -> dict:
        ...
        # АНТИ-ГАЛЛЮЦИНАЦИЯ (отключена - prompt расслаблен)
        # if not chunks:
        #     return {
