...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Grounded RAG Chat Agent")
    parser.add_argument("--eval-only", action="store_true",
                        help="Run evaluation only (non-interactive mode)")
    parser.add_argument("--config", default=None,
                        help="LLM config to use (overrides LLM_CONFIG env var)")
