"""
CLI-интерфейс для Agent с трёхслойной памятью и профилями.
"""
import os
...
def main():
    ...
    console.print("[bold green]Agent с трёхслойной памятью и профилями[/bold green]")
    console.print("Введите [bold]'help'[/bold] для списка команд\n")
    console.print("[dim]Команды: help, stats, reset, clear_working, clear_all, history, show_memory, profiles, profile use, profile show, demo, exit[/dim]\n")
