...
from app.prompts import PLANNING_PROMPT, EXECUTION_PROMPT, VALIDATION_PROMPT
...
class Agent:
    ...
    def _handle_fsm(self, user_message: str) -> dict:
        ...
        return {
            "text": "FSM режим. Используйте команды: /task start, /approve, /next, /pause, /resume, /reset, /status",
            "input_tokens": 0,
            "output_tokens": 0,
            "total_tokens": 0,
            "cost": 0,
