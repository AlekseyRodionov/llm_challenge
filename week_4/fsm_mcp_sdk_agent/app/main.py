...
def main():
    ...
    console.print("\n[bold green]╔══════════════════════════════════════════════════════════╗")
    console.print("[bold green]║           Agent с FSM, профилями и MCP SDK            ║")
    ...
    console.print("  mcp_connect, mcp_list, mcp_call, mcp_disconnect")
    ...
    while True:
        try:
            ...
            if command.startswith("mcp_call "):
                ...
                if not tool_name:
                    console.print("[red]Укажите название инструмента: mcp_call <tool_name>[/red]\n")
                    continue
                if not mcp_client:
                    console.print("[yellow]MCP not connected. Use mcp_connect first.[/yellow]\n")
                    continue
